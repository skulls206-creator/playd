  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        {/* Column headers — flat flex row; Title is flex-1 so Time is never squeezed off screen */}
        <div className="flex items-center px-3 h-8 border-b border-border bg-black/30 shrink-0 select-none overflow-hidden">
          {/* # */}
          <div className="w-10 shrink-0 text-right pr-2">
            <ColHeader col="trackNumber" label="#" extraClass="justify-end" />
          </div>
          {/* Title — always flex-1, absorbs all remaining space */}
          <div className="flex-1 min-w-0 relative pr-3">
          ...
          {/* Time — last column, always visible, same flat flow as all others */}
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      {/* Title — always flex-1, absorbs all remaining space; never pushes Time off screen */}
                      ...
                      {/* Duration — last column in normal flow, always visible */}
                      <div className="w-14 shrink-0 text-right">
                        {(track.duration ?? 0) > 0 ? (
                          <span className={clsx(
                            'text-[11px] font-mono',
